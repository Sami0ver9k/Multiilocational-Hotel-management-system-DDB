...
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (1, 1, 1, 1102, 2,'12-dec-2017','12-dec-2017','13-dec-2017', 01765448952,1);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (2, 2, 2, 1202, 3,'10-nov-2017','10-nov-2017','12-nov-2017', 01865548962,1);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (3, 3, 3, 1206, 2,'11-dec-2017','11-dec-2017','12-dec-2017', 01965648932,1);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (4, 4, 4, 1302, 4,'12-dec-2017','12-dec-2017','14-dec-2017', 01555448952,1);

insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (5, 5, 5, 2102, 2,'12-dec-2017','12-dec-2017','13-dec-2017', 01765448952,2);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (6, 6, 6, 2202, 3,'10-nov-2017','10-nov-2017','12-nov-2017', 01865548962,2);
...
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (9, 9, 9, 3102, 2,'12-dec-2017','12-dec-2017','13-dec-2017', 01765448952,3);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (10, 10, 10, 3202, 3,'10-nov-2017','10-nov-2017','12-nov-2017', 01865548962,3);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (11, 11, 11, 3206, 2,'11-dec-2017','11-dec-2017','12-dec-2017', 01965648932,3);
insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (12, 12, 12, 3302, 4,'12-dec-2017','12-dec-2017','14-dec-2017', 01555448952,3);

insert into booking (bookingId, guestId, staffId, roomNo,  numberofGuest, bookingDate, checkedin, checkout, telephone, branchId) values (13, 13, 13, 3302, 4,'12-dec-2017','12-dec-2017','14-dec-2017', 01555448952,1);
commit;
...
insert into payment (paymentId, methodId, dateofpay,  bookingId, totalPaid) values (1, 1, '12-oct-2017', 1, 2000);
insert into payment (paymentId, methodId, dateofpay,  bookingId, totalPaid) values (2, 1, '12-may-2017', 2, 2000);
insert into payment (paymentId, methodId, dateofpay,  bookingId, totalPaid) values (3, 2, '10-oct-2017', 3, 2000);
insert into payment (paymentId, methodId, dateofpay,  bookingId, totalPaid) values (4, 2, '12-oct-2017', 4, 2000);
